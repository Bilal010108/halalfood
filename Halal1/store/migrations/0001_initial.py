# Generated by Django 5.1.7 on 2025-03-26 06:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('клиент', 'клиент'), ('владелец', 'владелец'), ('курьер', 'курьер')], default='клиент', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carts_orders', to='store.cart')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock', models.PositiveSmallIntegerField(blank=True, default=1, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.categorytwo')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
                ...
                ('product_cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_cart', to='store.product')),
            ],
        ),
    ]
