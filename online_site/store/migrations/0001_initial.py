    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('клиент', 'клиент'), ('владелец', 'владелец')], default='клиент', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products_orders', to='store.product')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
